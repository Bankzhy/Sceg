            ...
            for method in sr_class.method_list:
                ...
                if len(related_classes) > 0:
                    for rcls in related_classes:
                        ...
                        class_level_graph_generator.to_fe_database(db=db, project_name=sr_project.project_name, group="original", source_class_name=sr_class.class_name, target_class_name=target_class.class_name, method_path=method_path)
