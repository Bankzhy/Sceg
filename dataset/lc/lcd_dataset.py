...
class LCDDataset(DGLDataset):
    ...
    def __init__(self,
        ...
        self.labels = []
        self.split = split
        super(LCDDataset, self).__init__(name='lcd_dataset',
                                         url=url,
                                         raw_dir=raw_dir,
    ...
    def _load_graph(self):
        ...
        pos_path = Path("dataset/lc/"+self.split + "_1.txt")
        neg_path = Path("dataset/lc/"+self.split + "_0.txt")
        failed_num = 0
