class StopWordRemover:
    def __init__(self):
        self.JAVA_KEYWORDS_STOP_WORD_SET = ["abstract", "continue", "for", "new", "switch", "assert", "default", "goto",
                                       "package",
                                       ...
                                       "super", "while", "org",
                                       "eclipse", "swt", "string", "main", "args", "null", "this", "extends", "true",
                                       "false"]
        self.ENG_STOP_WORDS_SET = ["a", "a's", "able", "about", "above", "according", "accordingly", "across", "actually",
                              ...
                              "besides", "best",
                              "better", "between", "beyond", "both", "brief", "but", "by", "c", "c'mon", "c's", "came",
                              "can",
                              ...
                              "those", "though",
                              "three", "through", "throughout", "thru", "thus", "to", "together", "too", "took",
                              "toward", "towards",
