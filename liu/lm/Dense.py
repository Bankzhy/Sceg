...
def train(projectName):
    print(projectName)
    df=pd.read_csv("/Volumes/rog/research/example/DeepSmellDetection-master/long method/Database/data_semi.csv",encoding='ISO-8859-1')
...
def load_models(projectName):
    ...
    for i in range(MODEL_NUMBER):
        ...
        clf=joblib.load("/Volumes/rog/research/example/DeepSmellDetection-master/long method/model/"+projectName+"_"+str(i)+".joblib")
