...
def train():
    ...
    for i in range(MODEL_NUMBER):
        ...
        # save model
        joblib.dump(clf, "/Volumes/rog/research/example/DeepSmellDetection-master/long method/model/" + "custom-v1" + "_" + str(i) + ".joblib")
...
def test_one(model):
    data_path = "/Volumes/rog/research/example/DeepSmellDetection-master/long method/Data Generation/dm_jsprit_result.csv"
    df = pd.read_csv(data_path,
                     encoding='ISO-8859-1')
    clf = model
    x = df.iloc[:, 4:13]
...
def load_models():
    ...
    for i in range(MODEL_NUMBER):
        ...
        clf=joblib.load("/Volumes/rog/research/example/DeepSmellDetection-master/long method/model/"+"custom-v1"+"_"+str(i)+".joblib")
